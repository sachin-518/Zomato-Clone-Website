...
$query3 = "SELECT * FROM address WHERE user_id LIKE '$user_id'";
	...
	<div class="container emp-profile">
            <form method="post" action="profile_pic.php" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-4" id="attr">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            while ($row = mysqli_fetch_assoc($result2)) {
                                                echo $count++.'. '.$row['address'].' ,'.$row['city'].' ,'.$row['pin'].'<br><br>';
                ...
                <div class="row" style="justify-content: flex-end;margin-right: 50px;">
                    <a href="#"><button type="submit" name="upload" class="pic mt-0 ml-5 btn btn-warning"><b>Update Profile</b></button></a>
                                </div>
                </div>
